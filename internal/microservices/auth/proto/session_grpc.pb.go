...
const (
	AuthService_CreateSession_FullMethodName = "/auth_proto.AuthService/CreateSession"
	AuthService_DeleteSession_FullMethodName = "/auth_proto.AuthService/DeleteSession"
	AuthService_GetSession_FullMethodName    = "/auth_proto.AuthService/GetSession"
)
...
func (c *authServiceClient) CreateSession(ctx context.Context, in *UID, opts ...grpc.CallOption) (*Session, error) {
	out := new(Session)
	err := c.cc.Invoke(ctx, AuthService_CreateSession_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
